...
WebUI.click(findTestObject('Object Repository/Remove Product/Page_Swag Labs/input_login-button'))

WebUI.click(findTestObject('Object Repository/Remove Product/Page_Swag Labs/button_Add to cart'))
